...
class Ledger {
     ...
     * @param {Object<string, Object>} updates - Key-value pairs of layerId and updates
     * @return {void}
     */
    set(updates) {
     ...
     * @returns {Object<string, Object>} - Object with layerId as key and current state as value.
     */
    get(layerIds) {
        const result = {};
     ...
     * @returns {Object<string, Object>|undefined} The state before the undo operation.
     ...
     * @returns {Object<string, Object>|undefined} The state after the redo operation.
